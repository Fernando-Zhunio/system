...
export class CreateOrEditPriceComponent extends CreateOrEdit<IProductPrice> implements OnInit {

  constructor(public location: Location, public act_router: ActivatedRoute, public standard_service: StandartSearchService, public router: Router) {
