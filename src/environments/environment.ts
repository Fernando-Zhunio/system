...
export const environment = {
  ...
  VAPID_PUBLIC_KEY: 'BP92cL1VfEVAKGGsOzkbT1ARvctczt6q_zWQ_HGshcKukAfxn1YXSyOToP2kyRKsbd4zek7dD-Lp_yRRc5h-inc',
  VAPID_PRIVATE_KEY: 'cjg2GtKGItWbetQFNehLK7R3BQC1uO5jEoI-aXKSrdg',
